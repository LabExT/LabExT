...
from tkinter import Label, Toplevel, Frame, Button, FLAT, TOP, RIGHT, X, Y, BOTH, NORMAL, DISABLED
...
class Wizard(Toplevel):
    ...
    def __init__(
        ...
        self._steps: Dict[int, Type[Step]] = {}
    ...
    def current_step(self, step: Type[Step]) -> None:
        """
        Sets the current step, updates the sidebar and reset error.
    ...
    def _cancel(self):
        ...
        """
        if self.on_cancel:
            self.on_cancel(self.current_step)
