...
class ChannelTest(SmarActTestCase):
    ...
    def test_set_speed_successfully(self):
        ...
        self.assertEqual(
            self.mcsc_mock.SA_SetClosedLoopMoveSpeed_S.call_args[0][2].value, int(
    ...
    def test_set_acceleration_successfully(self):
        ...
        self.assertEqual(
            self.mcsc_mock.SA_SetClosedLoopMoveAcceleration_S.call_args[0][2].value,
    ...
    def test_move_relative(self):
        ...
        self.assertEqual(
            self.mcsc_mock.SA_GotoPositionRelative_S.call_args[0][2].value, int(
    ...
    def test_move_absolute(self):
        ...
        self.assertEqual(
            self.mcsc_mock.SA_GotoPositionAbsolute_S.call_args[0][2].value, int(
                self._to_nanometer(requested_diff)))
