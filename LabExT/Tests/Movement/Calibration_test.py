...
class AxesRotationTest(unittest.TestCase):
    ...
    def test_default_case(self):
        ...
        self.assertTrue((expected_stage_coordinate == self.rotation.chip_to_stage(chip_coordinate)).all())
...
class WiggleAxisTest(unittest.TestCase):
    ...
    def test_wiggle_axis_raises_error_if_axes_rotation_is_invalid(self):
        ...
        axes_rotation.update(chip_axis=Axis.X, stage_axis=Axis.Y, direction=Direction.POSITIVE)
    ...
    def test_wiggle_axis_with_rotation(self, move_relative_mock):
        axes_rotation = AxesRotation()
        axes_rotation.update(chip_axis=Axis.X, stage_axis=Axis.Y, direction=Direction.NEGATIVE)
        axes_rotation.update(chip_axis=Axis.Y, stage_axis=Axis.Z, direction=Direction.POSITIVE)
        axes_rotation.update(chip_axis=Axis.Z, stage_axis=Axis.X, direction=Direction.NEGATIVE)
    ...
    def test_wiggle_axis_sets_and_resets_speed(self, set_speed_z_mock, set_speed_xy_mock, move_relative_mock):
        ...
        move_relative_mock.assert_has_calls([call(1000.0, 0, 0), call(-1000.0, 0, 0)])
...
class CalibrationTest(unittest.TestCase):
    ...
    def test_fix_coordinate_system_saves_rotation(self):
        ...
        self.assertEqual(self.calibration._state, State.COORDINATE_SYSTEM_FIXED)