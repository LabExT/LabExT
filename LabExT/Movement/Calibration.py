...
from LabExT.Movement.Transformations import ChipCoordinate, Coordinate, CoordinatePairing, SinglePointOffset, AxesRotation, KabschRotation, StageCoordinate
...
class Calibration:
    ...
    def __init__(self, stage, orientation, device_port) -> None:
    ...
    def coordinate_system(self, coordinate_system):
        ...
        if not issubclass(type(coordinate_system), Coordinate):
